...
news_data = {
    "news1": {
        "article_title": "News 1",
        "article_content": "Fire is a dynamic chemical reaction that releases heat and light as a result of the combustion of combustible materials. It has been a symbol of energy, transformation, and destruction throughout human history. Fire's mesmerizing dance embodies both the creative and destructive forces of nature, offering warmth and illumination while capable of consuming everything in its path.",
    ...
    "news2": {
        "article_title": "News 2",
        "article_content": "Earth, our home planet, is a complex and interconnected system of land, water, and atmosphere. It sustains life through a delicate balance of ecosystems and natural processes. From towering mountains to vast oceans, Earth's diverse landscapes provide habitats for countless species. Human activities profoundly impact the Earth, influencing its climate, biodiversity, and overall health. The importance of environmental stewardship has become increasingly evident as societies strive to achieve sustainability and protect the planet for future generations.",
    ...
    "news3": {
        "article_title": "News 3",
        "article_content": "Air, a mixture of gases primarily composed of nitrogen and oxygen, envelops the Earth, creating the atmosphere crucial for sustaining life. Beyond its role in respiration, air influences weather patterns and climatic conditions. The movement of air masses, driven by atmospheric pressure differentials, results in winds and plays a pivotal role in shaping the Earth's climate. Air pollution, caused by human activities, poses challenges to both environmental and public health, emphasizing the importance of responsible resource management and pollution control.",
